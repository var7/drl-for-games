...
from configs import pong_config, breakout_config, mario_config
...
if __name__ == '__main__':
    ...
    for episode in range(config['episodes']):
        ...
        if episode % config['episodes_validate']==0:
            print('Validate....\n==============')
            scores = [agent.validate_episode(epsilon=0.05, visualise = True) for i in range(config['episodes_validate_runs'])]
